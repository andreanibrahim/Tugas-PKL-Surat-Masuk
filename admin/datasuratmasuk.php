              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php if(!empty($_SESSION['alert'])) { ?>
                      <div style="margin: 0 5px;background:rgb(220, 190, 114);padding: 5px;border-radius: 5px">
                          <h4 style="margin: 0;color: white"><?php echo $_SESSION['alert']; ?></h4>
                      </div>
                      <?php unset($_SESSION['alert']); // Hapus setelah ditampilkan ?>
                  <?php } ?>
